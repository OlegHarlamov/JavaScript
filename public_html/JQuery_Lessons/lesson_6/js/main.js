...
// $('input:text').css('border', '1px solid red'); //Текствоые поля для ввода
...
// $('input: foucs').css('display', 'block'); //Выбранное поле(сострояние фокус)
// $('input:checkbox').css('border', '1px solid red'); //Выбранный чекбокс или радио-кнопка
