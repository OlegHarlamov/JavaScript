...
Basket.prototype.add = function (product, quantity, price) {
	...
	this.basketItems.push; //добавляем обект товара в наш массив товаров
	this.refresh();
};

Basket.prototype.refresh = function () {
	var $basksetDataDiv = $('#basket_data');

	$basksetDataDiv.append('<p>Всего товаров: ' +this.countGoods + '</p>');
	$basksetDataDiv.append('<p>Сумма: ' +this.amount + '</p>');
};
